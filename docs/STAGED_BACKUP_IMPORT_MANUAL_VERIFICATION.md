...
Use `docs/STAGED_BACKUP_IMPORT_LOCAL_TEST_PLAN.md` to execute these checks locally. Record manual run results in `docs/STAGED_BACKUP_IMPORT_MANUAL_VERIFICATION_RESULTS.md` after using this checklist. The initial Prompt 083 verification record is `docs/STAGED_BACKUP_IMPORT_MANUAL_VERIFICATION_RECORD.md`.
...
Expected current staged-backup baseline:
